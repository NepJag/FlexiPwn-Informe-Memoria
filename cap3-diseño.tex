...
monitor (caso de MySQL con \texttt{general\_log}). Un escenario que use una base
...
\texttt{TargetResult} y para notificar al usuario a través de la CLI.
...
\textit{match} serializado como JSON. Tiene índice ordinario sobre
\texttt{run\_id} para recuperar eficientemente todos los resultados de un run.
