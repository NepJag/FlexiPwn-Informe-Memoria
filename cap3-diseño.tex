...
\begin{figure}[H]
    ...
    \caption{[Placeholder] Flujo de datos entre las cuatro capas y el
    educador: estado observable, eventos estructurados, resultados de
    evaluación, ciclo de vida y YAML del escenario.}
    \label{fig:flujo-capas}
\end{figure}

\section{Modelo de Datos}

% PLACEHOLDER: reemplazar por imagenes/erd.pdf (flexipwn_erd_v2.pdf de Notion).
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth, height=0.4\textwidth]{imagenes/escudoU2014.pdf}
    \caption{[Placeholder] Diagrama entidad-relación del modelo de datos de
    FlexiPwn.}
    \label{fig:erd}
\end{figure}
...
en memoria. El reenlace entre la hoja del modelo \texttt{Pydantic} de la Capa 3
y su fila
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\textwidth, height=0.4\textwidth]{imagenes/escudoU2014.pdf}
    \caption{[Placeholder] Topología de red del entorno: red interna y
    externa con el \textit{sidecar} y los tres contenedores. El vulnerable
    solo en la red interna, el atacante en ambas, y el \textit{sidecar}
    compartiendo el \textit{netns} del vulnerable.}
